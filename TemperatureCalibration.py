...
def cal_ultqpg1_1k6(x):
    ...
    t = np.exp(
        + 12674.0497718906
        - 59961.0504895809 * x
        + 98237.0494272492 * x ** 2
        - 73893.0848166449 * x ** 3
        + 21054.6297895868 * x ** 4
        + 6223.6744376086 * x ** 5
        - 7035.6821344221 * x ** 6
        + 2387.40413113769 * x ** 7
        - 414.88721857792 * x ** 8
        + 62.2479227885363 * x ** 9
        - 17.5411761255037 * x ** 10
        + 3.61857266143431 * x ** 11
        - 0.181613033321708 * x ** 12
        - 0.0407593699814338 * x ** 13
        + 0.00445085930378856 * x ** 14)
