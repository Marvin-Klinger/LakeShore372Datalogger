...
#         - 5034.53028695154
#         + 21855.1507379283 * x
#         - 40834.2802671851 * x ** 2
#         + 42421.8362408108 * x ** 3
#         - 26144.0498055474 * x ** 4
#         + 9090.05346206338 * x ** 5
#         - 1209.37614306462 * x ** 6
#         - 230.871197845189 * x ** 7
#         + 58.8271526295355 * x ** 8
#         + 29.5534842179452 * x ** 9
#         - 13.9356395561845 * x ** 10
#         + 1.78384899497698 * x ** 11
#         + 0.0945094726768133 * x ** 12
#         - 0.0426796673407719 * x ** 13
#         + 0.00291846607831256 * x ** 14)
#
#     if t < 0.04: #this is quite high, but the cal run was not perfect V2.4r10
#         return np.nan
#     return t


def cal_UTC02b(resistance):
    if resistance > 6149:
        return np.nan
    if resistance < 435:
        return np.nan
    ...
    t = np.exp(
        - 139.632031674157
        + 892.022239465635 * x
        - 2559.83396233311 * x ** 2
        + 4171.27849929896 * x ** 3
        - 4188.33460223003 * x ** 4
        + 2580.55099164628 * x ** 5
        - 831.434780740919 * x ** 6
        - 18.9760623103014 * x ** 7
        + 137.490483849887 * x ** 8
        - 54.4283055188901 * x ** 9
        + 6.8037520794862 * x ** 10
        + 1.50502176316866 * x ** 11
        - 0.684269566564463 * x ** 12
        + 0.098875422707884 * x ** 13
        - 0.00531927632621261 * x ** 14)
...
def cal_U12486(resistance):
    ...
    t = np.exp(
        -3.57268174348226
        + 2.33373045772286 * x
        + 0.285682594651379 * x ** 2
        + 0.764491662298044 * x ** 3
        + 0.0350452562285361 * x ** 4
        - 4.9414432540306 * x ** 5
        + 1.93619126496995 * x ** 6
        + 14.6384717477476 * x ** 7
        - 10.7826659256942 * x ** 8
        - 16.6883477926532 * x ** 9
        + 19.7698844551296 * x ** 10
        + 2.27551800573355 * x ** 11
        - 11.4041519632019 * x ** 12
        + 5.50242435394528 * x ** 13
        - 0.842670058888194 * x ** 14)
...
def cal_UTQ16(resistance):
    ...
    t = np.exp(
        ...
        + 1.1092547000794 * x ** 2
        - 10.162838982339 * x ** 3
        + 43.1872193645254 * x ** 4
        - 101.500312062321 * x ** 5
        + 147.904774168071 * x ** 6
        - 140.713895346259 * x ** 7
        + 88.9521473942697 * x ** 8
        - 37.0304110096871 * x ** 9
        + 9.74721727053666 * x ** 10
        - 1.46929590559703 * x ** 11
        + 0.096583033863356 * x ** 12)
...
def cal_UTQ16_extendedRange(resistance):
    if resistance > 78526:
        return np.nan
    if resistance < 2500:
        return np.nan
    ...
    t = np.exp(
        - 3.55085471844738
        + 0.807134533661034 * x
        + 0.363134338273588 * x ** 2
        - 2.21545798385634 * x ** 3
        + 6.96935265093723 * x ** 4
        - 11.1713027253176 * x ** 5
        + 10.5303838828216 * x ** 6
        - 6.27185431819065 * x ** 7
        + 2.43742412278307 * x ** 8
        - 0.61861007605154 * x ** 9
        + 0.0990375540996032 * x ** 10
        - 0.00908917168748336 * x ** 11
        + 3.64723883162646E-4 * x ** 12)
...
def cal_UTC_1k_C02(resistance):
    if resistance > 8616.32192:
        return np.nan
    if resistance < 1337.7537:
        return np.nan
    x = 12.0 - np.log(resistance - 900)
    t = np.exp(
        - 11698.1555265018
        + 22602.0502961486 * x
        - 18128.0732714504 * x ** 2
        + 7585.49617050611 * x ** 3
        - 1711.71716413143 * x ** 4
        + 253.823104452278 * x ** 5
        - 94.3066229139009 * x ** 6
        + 49.6550992753733 * x ** 7
        - 15.2864906474901 * x ** 8
        + 2.75152698210421 * x ** 9
        - 0.293966483661329 * x ** 10
        + 0.0174277925167132 * x ** 11
        - 4.44110728714338E-4 * x ** 12)

    if t < 0.04 or t > 8:
        return np.nan
    return t

def cal_UTC_1k_C03(resistance):
    if resistance > 8473.27671232877:
        return np.nan
    if resistance < 1337.7537:
        return np.nan
    x = 11.2 - np.log(resistance - 1000)
    t = np.exp(
        -3.05793705294414
        - 534.207757570155 * x
        + 1214.48921853996 * x ** 2
        - 1133.06576292903 * x ** 3
        + 496.464892326567 * x ** 4
        - 33.6411789822293 * x ** 5
        - 78.0046827449909 * x ** 6
        + 45.805412043772 * x ** 7
        - 13.5667448042763 * x ** 8
        + 2.45100834974975 * x ** 9
        - 0.273232045825464 * x ** 10
        + 0.0173568958755222 * x ** 11
        - 4.82422719617972E-4 * x ** 12)
...
def cal_UTC_1k_B03(resistance):
    ...
    t = np.exp(
        + 14.5160218647078
        - 165.907106848549 * x
        + 666.548622836254 * x ** 2
        - 1484.36543768634 * x ** 3
        + 2037.51934970325 * x ** 4
        - 1773.11867007351 * x ** 5
        + 946.852568911632 * x ** 6
        - 255.234634792025 * x ** 7
        - 14.5622386870293 * x ** 8
        + 36.7917444257577 * x ** 9
        - 12.6118911383212 * x ** 10
        + 1.97772421835028 * x ** 11
        - 0.124043463110834 * x ** 12)
...
def cal_UTC_1k_Chip01 (resistance):
    if resistance > 7350.0:
        return np.nan
    if resistance < 1728.0:
        return np.nan
    x = 11.2 - np.log(resistance - 1400.0)
    t = np.exp(
        - 718.95354504791
        + 2276.25703333468 * x
        - 3272.40711663775 * x ** 2
        + 2807.34695654049 * x ** 3
        - 1615.76434294052 * x ** 4
        + 669.890250207371 * x ** 5
        - 210.443706036217 * x ** 6
        + 51.6495679962848 * x ** 7
        - 9.90624990202019 * x ** 8
        + 1.43027203086253 * x ** 9
        - 0.144079593167415 * x ** 10
        + 0.00888414641534413 * x ** 11
        - 2.49463964084498E-4 * x ** 12)

    if t < 0.0445 or t > 1.92:
        return np.nan
    return t
