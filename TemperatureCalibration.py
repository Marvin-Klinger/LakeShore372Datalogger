...
def cal_cam_cool(x):
    ...
    return np.exp(-373.324833537336 + 1835.73209954042 * x + -4018.95152389788 * x ** 2 + 5075.32470465038 * x ** 3 -
                  4024.10519986429 * x ** 4 + 2007.37379498485 * x ** 5 + -553.69425307273 * x ** 6 +
                  14.4547644513859 * x ** 7 + 50.7679268762599 * x ** 8 + -19.6351577592401 * x ** 9 +
                  3.23058359061518 * x ** 10 - 0.0864277572426083 * x ** 11 + -0.0563530241340467 * x ** 12 +
                  0.00890500341378714 * x ** 13 + -4.42618590943774E-4 * x ** 14)
