...
def cal_cryopump(x):
    x = 11.2 - np.log(x - 1400)
    t = np.exp(2362.18330877245 * x
               - 2222.40320702294 * x ** 2
               - 3002.63341995946 * x ** 3
               + 5892.21634326697 * x ** 4
               - 4055.78404898106 * x ** 5
               + 1659.06072023268 * x ** 6
               - 504.364659813538 * x ** 7
               + 66.1993977018042 * x ** 8
               + 43.0051416702139 * x ** 9
               - 22.4814964652787 * x ** 10
               + 2.28947556962807 * x ** 11
               + 0.353585091984669 * x ** 12
               + 0.10770262428786 * x ** 13
               - 0.0695116035390763 * x ** 14
               + 0.00765594432605082 * x ** 15)
    return t
