...
def cal_Right(x):
	x = 11.2 - np.log(x - 1400)
	return np.exp(-0.0047002229476546175 * x**14 + 0.10154839171994177 * x**13 + -0.981847230265907 * x**12 + 5.613781350429444 * x**11 + -21.13906564640869 * x**10 + 55.29801834851239 * x**9 + -103.39924286617787 * x**8 + 140.24679773534186 * x**7 + -138.7500431496065 * x**6 + 99.85528711982734 * x**5 + -51.532230714255164 * x**4 + 18.328862627881602 * x**3 + -3.8237048229160484 * x**2 + 0.8497915833057025 * x**1 + -3.073459431278023)	T = np.exp(0.0005368609224647498 * x**14 + -0.009126837954172535 * x**13 + 0.0640253268393166 * x**12 + -0.2289249432279129 * x**11 + 0.3679144361255609 * x**10 + 0.20991931832280147 * x**9 + -2.213917518277363 * x**8 + 4.752733335232428 * x**7 + -5.546908091682508 * x**6 + 3.9553362153705445 * x**5 + -1.7938495644668326 * x**4 + 0.4814947839702955 * x**3 + 0.27078722616901435 * x**2 + 0.27785056104331857 * x**1 + -2.919713785690113)
    if (T > 2) or (T < 0.01):
        return 400
    return T
